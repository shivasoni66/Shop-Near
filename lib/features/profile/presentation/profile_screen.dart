          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(user.name, style: AppTextStyles.h2.copyWith(fontSize: 21, fontWeight: FontWeight.w900, color: AppColors.text)),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      if (user.role == 'seller') ...[
                        _buildStat(ref.watch(sellerProductsProvider).value?.length.toString() ?? '0', 'Products', null),
                        _buildDivider(),
                        _buildStat(ref.watch(sellerOrdersProvider).value?.length.toString() ?? '0', 'Sales', 1),
                        _buildDivider(),
